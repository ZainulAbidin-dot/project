...
export const showUsers = async () => {
  ...
  for (const user of users) {
    const item = itemTemplate.content.firstElementChild.cloneNode(true);
    item.setAttribute('data-order-id', user.id);
    item.querySelector('.customer__id').textContent = user.id;
    item.querySelector('.customer__name').textContent = user.name;
    item.querySelector('.customer__order').textContent =
